...
def enviar_mensagem():
    ...
    if chatcrabiz.enviar_mensagem(mensagem, contato):  # Adicione o nome do remetente como argumento
        return redirect('/chat')
    else:
...
def carregar_mensagens():
    ...
    if nome_destinatario:
        # Obtenha as mensagens apenas para o contato especificado
...
def enviarMensagem():
    ...
    if 'usuario' in session:
        ...
        chat = Chat(usuario_logado['nome']) 

        destinatario = destinatario("") 
        
        chat.enviar_mensagem(destinatario, mensagem)
